...
if __name__ == '__main__':
    ...
    parser.add_argument('-tp', '--transition_probability', type=float, default=0.1)
    ...
    plt.savefig(f'results/bayesian_optimality_train_p_t=0.1_test_p_t={args.transition_probability}.png', dpi=300)
